...
class UpdateShowPage extends StatefulWidget {
  final Map<String, dynamic> show; // Pass the show to be updated
...
Future<void> _pickImage(ImageSource source) async {
  ...
  Future<void> _updateShow() async {
    ...
    var request = http.MultipartRequest('PUT', Uri.parse('${ApiConfig.baseUrl}/shows/${widget.show['id']}'));
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pop(context, true); // Return true to refresh the page
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
...
maxLines: 3,
            ...
            _imageFile == null
                ? widget.show['image'] != null
                    ? Image.network('${ApiConfig.baseUrl}${widget.show['image']}', height: 150, fit: BoxFit.cover)
